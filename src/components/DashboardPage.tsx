...
const DashboardPage = () => {
  ...
  const canViewReports = user?.role === 'admin' || user?.role === 'teacher';
  const canViewEvaluationReports = user?.role === 'admin' || user?.role === 'teacher';
  const canViewQuickActions = user?.role === 'admin' || user?.role === 'teacher';
  const canViewGeneralView = user?.role === 'admin' || user?.role === 'teacher';
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-gray-800 text-white flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          {/* Administración - Todos pueden ver pero con restricciones */}
          <div>
            <button
          ...
          {/* Evaluaciones - Todos pueden ver pero con restricciones */}
          <div>
            <button
            ...
            {isMenuOpen('evaluaciones') && (
              <div className="ml-4 mt-1 space-y-1 border-l border-gray-600 pl-4">
                ...
                {/* Reportes de Evaluaciones - Solo Admin y Teachers */}
      ...
      <main className="flex-1 p-6 overflow-y-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800">
            ...
            {user?.role === 'student' && ' - Vista Estudiante'}
            {user?.role === 'teacher' && ' - Vista Profesor'}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Widget de Actividad Reciente - Todos pueden ver */}
          <div className="bg-white rounded-lg shadow-md p-6">
          ...
          {/* Widget de Acciones Rápidas - Solo Admin y Teachers */}
          {canViewQuickActions && (
            <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="mt-8 bg-white rounded-lg shadow-md p-6">
            ...
            {user?.role === 'admin' && (
              <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                <h4 className="font-semibold text-blue-800 mb-2">Privilegios de Administrador</h4>
                <ul className="text-sm text-blue-700 list-disc list-inside space-y-1">
                  <li>Acceso completo a todos los módulos</li>
                  <li>Gestión de reportes y estadísticas</li>
            ...
            {user?.role === 'teacher' && (
              <div className="mt-4 p-4 bg-green-50 rounded-lg">
                <h4 className="font-semibold text-green-800 mb-2">Privilegios de Profesor</h4>
                <ul className="text-sm text-green-700 list-disc list-inside space-y-1">
                  <li>Gestión de cursos y evaluaciones</li>
                  <li>Acceso a reportes académicos</li>
                  <li>Control de contenido educativo</li>
                </ul>
              </div>
            )}
          </div>
        ...
        {user?.role === 'student' && (
          <div className="mt-8 bg-white rounded-lg shadow-md p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Vista Estudiante</h3>
            ...
            <div className="p-4 bg-yellow-50 rounded-lg">
              ...
              <ul className="text-sm text-yellow-700 list-disc list-inside space-y-1">
                <li>Visualización de cursos inscritos</li>
                <li>Consulta de evaluaciones pendientes</li>
                <li>Revisión de actividades recientes</li>
